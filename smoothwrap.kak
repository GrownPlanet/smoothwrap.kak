...
define-command smoothwrap-down -docstring "go down one line" %{
    ...
    execute-keys x
    execute-keys %sh{
        "$kak_config/plugins/smoothwrap.kak/smoothwrap" "down" "$kak_opt_cursor_column" "$kak_selection" "$kak_opt_wrap_width"
    }<ret>
...
define-command smoothwrap-up -docstring "go up one line" %{
    ...
    execute-keys x
    execute-keys %sh{
        "$kak_config/plugins/smoothwrap.kak/smoothwrap" "up" "$kak_opt_cursor_column" "$kak_selection" "$kak_opt_wrap_width"
    }<ret>
